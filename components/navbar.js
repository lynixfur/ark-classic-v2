...
function Navbar(props) {
  ...
  return (
    <>
      <div className={navBg ? 'fixed w-full text-gray-700 text-gray-200 bg-gray-800 border-b border-gray-700 z-50' : 'fixed w-full text-gray-700 text-gray-200 z-50 bg-bgray-bg bg-opacity-0 '}>
        <div
          x-data="{ open: false }"
        ...
        >
          <div className="flex flex-row items-center justify-between p-4">
            ...
            >
              <img
                alt="Bloody ARK Logo"
                className="h-10 mr-2"
                src="https://cdn.discordapp.com/attachments/885607142051184700/989491522225463316/unknown.png"
              />
              <p className="my-auto">ARKClassic</p>
            </a>
            <button
          ...
          <nav className={mobileMenu ? 'flex flex-col flex-grow pb-4 md:pb-0 md:flex md:justify-end md:flex-row' : 'flex-col flex-grow hidden pb-4 md:pb-0 md:flex md:justify-end md:flex-row'}>
            ...
            {/* Hub Section for button - Disabled Hub Permanantly */}
            <div className="relative my-auto">
              <a href="https://portal.arkclassic.com/" className="bg-bred-2 flex flex-row items-center w-full px-4 py-2 mt-2 text-sm font-semibold text-left rounded-full md:w-auto md:inline md:mt-0 md:ml-4">
                <span>
                  <i className="fas fa-cubes mr-2"></i> Portal
                </span>
              </a>
              </div>              
            {/* Hub Section for button - Disabled Hub Permanantly */}
