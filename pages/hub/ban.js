    ...
    return (
        ...
        <section className="flex flex-col md:flex-row h-screen items-center">
          ...
          <div className="bg-bgray-bg w-full md:max-w-md lg:max-w-full md:mx-auto md:mx-0 md:w-1/2 xl:w-1/3 h-screen px-6 lg:px-16 xl:px-12
            ...
            <iframe  src="https://www.youtube.com/embed/uSiHqxgE2d0?autoplay=1" title="Ray Charles - Hit The Road Jack (Official Lyrics Video)" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
