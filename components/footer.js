            ...
            <nav className="list-none mb-10">
              <li>
                <a
                  ...
                  href="https://shop.arkclassic.com/terms/privacy"
                >
              ...
              <li>
                <a
                  className="text-white hover:text-red-300"
                  href="https://shop.arkclassic.com/terms/checkout"
                >
          ...
          <div className="lg:w-1/4 md:w-1/2 w-full px-4">
            ...
            <nav className="list-none mb-10">
              <li>
                <a
                  className="text-white hover:text-red-300"
                  href="https://steamcommunity.com/groups/arkclassic"
                >
              ...
              <li>
                <a
                  className="text-white hover:text-red-300 hidden"
                  href="https://hub.arkclassic.com/"
                >
                  <i className="fa-solid fa-layer-group mr-2" /> Ark Classic Hub
                </a>
              </li>
            </nav>
          </div>
            ...
            <a href="https://www.nitrado-aff.com/KBLKT9/D42TT/">
              ...
              <nav className="list-none mb-10 flex justify-center sm:justify-left sm:block">
                <img
                  alt="Bloody ARK Logo"
                  className="w-32"
                  src="/images/Nitrado_Logo_yellow_TextToTheSide_white_border.png"
                />
              </nav>
            </a>
          </div>
      ...
      <div className="bg-gray-700">
        <div className="container mx-auto py-4 px-5 flex flex-wrap flex-col sm:flex-row">
          <p className="text-white text-sm text-center sm:text-left">
            Copyright © 2022 ARK Classic. All Rights Reserved.
          </p>
